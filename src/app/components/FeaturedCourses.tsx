    ...
    <div className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-16">
          ...
          <a href="/courses" className="text-indigo-600 hover:underline flex items-center">
            ...
            <div key={idx} className="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="px-2 py-1 bg-indigo-100 text-indigo-800 rounded-full text-xs">{course.category}</span>
                </div>
                ...
                <a
                  href="/courses"
                  className="w-full block text-center py-3 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition"
                >
                  View Course
                </a>
              </div>
